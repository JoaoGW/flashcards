    ...
    <div>
      <div className={styles.cards}>
        ...
        <div className={styles.div_botoes}>
          <button class={styles.botoes} title="Voltar para o flashcard anterior" onClick={ props.voltarNPergunta }>
          ...
          <button className={styles.botoes} title="Pular para o próximo flashcard" onClick={ props.setNPergunta }>
            Pular pergunta
